...
#implementation
file_path = (r'C:\Users\mtuma\Manifesto-Summarisation-Project\Manifestos\SDLP\SDLPManifesto.txt')
...
#write to files
with open('common_Social Democratic and Labour Party.json', 'w') as f:
    json.dump(common_words, f)

# with open('common_Reform_bigrams.json', 'w') as f:
#     json.dump(common_bigrams, f)

with open('common_Social Democratic and Labour Party_trigrams.json', 'w') as f:
